...
qmail-fixsmtpio: \
load qmail-fixsmtpio.o commands.o case.a stralloc.a alloc.a substdio.a error.a str.a
	./load qmail-fixsmtpio commands.o case.a stralloc.a alloc.a substdio.a error.a str.a
