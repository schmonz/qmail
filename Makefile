...
qmail-reup: \
load qmail-reup.o sig.a wait.a error.a substdio.a str.a
	./load qmail-reup sig.a wait.a error.a substdio.a str.a

qmail-reup.o: \
compile qmail-reup.c readwrite.h sig.h substdio.h wait.h
